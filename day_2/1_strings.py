...
# --- Slicing : you can grab a chunk/slice of a string (substring) using a slicing
...
# --- .title() : formats string in a title case, capitalzing every word that is separated by a space
...
# --- .split() : by default splits each word separated by a space into a list
...
people = ["Tyler", "Jeramiah", "Jeremaine", "Jasmine", "Brian", "Travis", "Dylan"]
j_team = []
...
# --- .endwith() : returns True or False depending on whether a string ends with a certain substring or not
...
# --- .isspace() : returns True if a string is comprised of ENTIRELY of ONLY whitespace
